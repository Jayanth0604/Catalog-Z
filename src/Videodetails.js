    ...
    <div className="container-fluid tm-container-content tm-mt-60">
                ...
                <div className="tm-bg-gray tm-video-details">
                    ...
                    <div className="mb-4 d-flex flex-wrap">
                        <div className="mr-4 mb-2">
                            <span className="tm-text-gray-dark">Resolution: </span><span className="tm-text-primary">1920x1080</span>
                        </div>
                        <div className="mr-4 mb-2">
                            <span className="tm-text-gray-dark">Format: </span><span className="tm-text-primary">MP4</span>
                        </div>
                        <div>
                            <span className="tm-text-gray-dark">Duration: </span><span className="tm-text-primary">00:00:20</span>
                        </div>
                    </div>
                    <div className="mb-4">
        ...
        <div className="row mb-3 tm-gallery">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                ...
                <div className="d-flex justify-content-between tm-text-gray">
                    <span className="tm-text-gray-light">21 Sep 2020</span>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                ...
                <div className="d-flex justify-content-between tm-text-gray">
                    <span className="tm-text-gray-light">18 Sep 2020</span>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                ...
                <div className="d-flex justify-content-between tm-text-gray">
                    <span className="tm-text-gray-light">9 Sep 2020</span>
